...
func TestTranslations(t *testing.T) {
	...
	test.AlphaspaceString = "a!"
	test.AlphanumspaceString = "a!"
	test.AlphanumunicodeString = "未来の文字コード体系に私達は不安をもっています｡"
	...
	tests := []struct {
		...
		},
		{
			...
			expected: "AlphaspaceString darf nur alphabetische Zeichen und Leerzeichen enthalten",
		},
		{
